                ...
                <div className='w-full px-4 lg:w-1/2 xl:w-6/12'>
                  <div className='mb-12 max-w-[570px] lg:mb-0'>
                    ...
                    <p className='text-base leading-relaxed mb-9 text-body-color'>
                      Got a question about us? Are you interested in our gifts?
                      Have some suggestions or just want to say Hi? Just contact
                      us. We are here to asset you.
                    </p>
                    <div className='mb-8 flex w-full max-w-[370px]'>
                      <div className='mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-primary bg-opacity-5 text-brightRed sm:h-[70px] sm:max-w-[70px]'>
                        <svg
                          width={24}
                          height={24}
                          viewBox='0 0 24 24'
                  ...
                  <div className='relative p-8 bg-white rounded-lg shadow-lg sm:p-12'>
                    <form>
                      ...
                      <div>
                        <button
                          type='submit'
                          className='w-full p-3 text-white transition border rounded border-brightRed bg-brightRed hover:bg-opacity-90'
                        >
                          Send Message
                        </button>
                      </div>
